...
tau %tau(1st row) for b=1 and tau(2nd row) for b=2. Each column indicates each information set at different stages. For example. 4th column is for T=2 (k_1=1, a_1=1, b_1=1, k_2=2)
